document.addEventListener("DOMContentLoaded", function () {
  ...
  // Event listener for showing the input container when the edit button is clicked
    ...
    fetch(`/congno/get-order/${orderId}`)
      ...
      .then((data) => {
        if (data.bill_photo) {
          ...
          uploadedBillPhoto.src = `/${data.bill_photo}`;
  ...
  function displayNoImageMessage() {
    ...
    uploadedBillPhoto.alt = "Chưa cập nhật hình ảnh";
          ...
          compressImage(imageUpload.files[0], 800, 0.7, (compressedFile) => {
            ...
            fetch("/congno/save-data", {
              ...
              .then((data) => {
                ...
                inputContainer.style.display = "none"; // Hide input container after save
              })
              .catch((error) => {
