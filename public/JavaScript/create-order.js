document.addEventListener("DOMContentLoaded", function () {
  ...
  printButton.innerHTML =
    '<img src="../Assets/images/printericons-02.png" alt="Print" style="width: 20px; height: 20px;">';
  ...
  newOrderButton.innerHTML =
    '<img src="../Assets/images/plus.png" alt="New Order" style="width: 20px; height: 20px;">';
  newOrderButton.className = "button-common new-order-button";
